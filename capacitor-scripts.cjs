...
async function prepareCapacitor() {
  try {
    ...
    console.log('\nTo build your app:');
    console.log('1. Run "npx cap open android" to open the project in Android Studio');
    console.log('2. In Android Studio, select Build > Build Bundle(s) / APK(s) > Build APK(s)');
